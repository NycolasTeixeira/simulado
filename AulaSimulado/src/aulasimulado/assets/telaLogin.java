...
public boolean valida(){
    return !(this.email.getText().isEmpty() || this.senha.getText().isEmpty());
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                .addComponent(email)
                                .addComponent(senha, javax.swing.GroupLayout.DEFAULT_SIZE, 282, Short.MAX_VALUE))
    ...
    if(valida()) {
      ...
      Usuario usuario = new UsuarioDAO().buscarGerentePorEmail(usuario);
        ...
        JOptionPane.showMessageDialog(null, "insira o usuario correto");
    }
